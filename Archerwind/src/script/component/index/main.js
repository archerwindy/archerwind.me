...
export default class Main extends Component {
  ...
  _drawLogo() {
    var logo = new Vivus( 'archer-logos', {
        type: 'oneByOne',
        duration: 1000,
        animTimingFunction: Vivus.EASE,
        reverseStack: false
    }, this._animationCallback.bind( this ) );
  ...
  render() {
    ...
    let fillClasses = classnames({
        'finished' : ( this.state.isAnimateFinished === true )
    });

    let arrowClasses = classnames({
        'finished' : ( this.state.isArrowFinished === true )
    });
          ...
          <g id="Desktop-Wireframe">
          	<g id="Desktop-Main" transform="translate(-933.000000, -838.000000)">
          		<g id="icon-arrow" transform="translate(934.000000, 838.000000)">
          			<path id="Line" fill="transparent" className={ fillClasses } d="M17.5,17.6L0.2,0.2" stroke="rgba(34, 31, 32, 1.0)"/>
          			<path id="Line-Copy" fill="transparent" className={ fillClasses } d="M34.1,17.4L51.4,0" stroke="rgba(34, 31, 32, 1.0)"/>
          		</g>
          	</g>
          </g>
        </svg>
